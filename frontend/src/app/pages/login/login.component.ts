    ...
    <div class="auth-root">
      ...
      <section class="auth-hero">
        <div class="auth-hero-inner">
          <!-- LEFT: Hero copy -->
          <div class="hero-left">
            <h1 class="hero-title anim-up">Analyze Your<br><span class="gradient-text">Web Traffic</span></h1>
            <p class="hero-sub anim-up d2">
              Gain deep insights into your website's performance with real-time traffic analytics, conversion tracking, and visitor behavior heatmaps — all in one powerful dashboard.
            </p>
            <div class="hero-badges anim-up d3">
              <span class="badge-pill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg> Real-Time Analytics</span>
              <span class="badge-pill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg> Live Traffic</span>
              <span class="badge-pill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg> Device Insights</span>
            </div>
          </div>
      ...
      <footer class="footer">
        <div class="footer-top">
          ...
          <div class="footer-links">
            <div class="footer-col"><h4>Product</h4><a routerLink="/">Dashboard</a><a routerLink="/traffic">Traffic</a><a routerLink="/conversions">Conversions</a></div>
