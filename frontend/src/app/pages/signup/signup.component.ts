    ...
    <div class="auth-root">
      ...
      <section class="auth-hero">
        <div class="auth-hero-inner">
          <!-- LEFT -->
          <div class="hero-left">
            <h1 class="hero-title anim-up">Start Tracking<br>Your <span class="gradient-text">Website Growth</span></h1>
            <p class="hero-sub anim-up d2">
              Join thousands of webmasters using ScribeCount Traffic to understand visitor behavior, track conversions, and optimize their websites with data-driven insights.
            </p>
            <div class="hero-badges anim-up d3">
              <span class="badge-pill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" width="16" height="16"><polyline points="20 6 9 17 4 12"/></svg> Free to Start</span>
              ...
              <span class="badge-pill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg> Real-Time Data</span>
            </div>
          </div>
...
export class SignupComponent {
  ...
  onSubmit() {
    ...
    this.auth
      .signup(this.email.trim(), this.password, this.name.trim())
      .pipe(finalize(() => this.isSubmitting.set(false)))
      .subscribe({
        next: () => {
          this.successMessage.set('Account created successfully! Launching the Connection Setup Wizard...');
          setTimeout(() => void this.router.navigate(['/websites'], { queryParams: { setup: '1' } }), 800);
        },
