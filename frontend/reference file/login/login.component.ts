...
@Component({
    ...
    <div class="auth-root">
      ...
      <section class="auth-hero">
        <div class="auth-hero-inner">
          <!-- LEFT: Hero copy -->
          <div class="hero-left">
            <h1 class="hero-title anim-up">Manage Your<br><span class="gradient-text">Book Links</span></h1>
            <p class="hero-sub anim-up d2">
              Create Universal Book Links, track every click, and grow your readership with powerful analytics — all in one place.
            </p>
            <div class="hero-badges anim-up d3">
              <span class="badge-pill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg> Analytics</span>
              <span class="badge-pill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg> Universal Links</span>
              <span class="badge-pill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg> Smart Routing</span>
            </div>
          </div>
          ...
          <div class="form-side anim-up d2">
            <div class="auth-card">
              <h2 class="card-title">Welcome to ScribeCount!</h2>
              ...
              <form (ngSubmit)="onSubmit()" class="auth-form" novalidate>
                <div class="form-group">
                  <input id="login-email" type="email" [(ngModel)]="email" name="email"
                    placeholder="Enter your username or email" autocomplete="email"
                ...
                <div class="form-group">
                  <div class="input-wrapper">
                    <input id="login-password" [type]="showPassword ? 'text' : 'password'"
                      ...
                      autocomplete="current-password" (input)="clearError('password')"
                ...
                <button id="login-submit-btn" type="submit" class="auth-submit-btn" [disabled]="isSubmitting()">
              ...
              <p class="card-alt-text">Don't have an account?</p>
              <a routerLink="/signup" class="btn-outline">Create an account</a>
            </div>
          </div>
        </div>
      </section>
  ...
  styles: [`
    ...
    .auth-hero {
      min-height:100vh;
      background:linear-gradient(135deg,rgb(22,38,62) 0%,rgb(30,55,95) 40%,rgb(16,28,46) 100%);
    ...
    .badge-pill {
      ...
      border-radius:100px;font-size:.8rem;font-weight:600;color:rgba(255,255,255,.85);
    }

    /* RIGHT CARD */
    .form-side { display:flex;justify-content:center; }
    .auth-card {
      width:100%;max-width:420px;background:white;border-radius:18px;padding:2.25rem;
      box-shadow:0 20px 60px rgba(0,0,0,.2),0 0 0 1px rgba(0,0,0,.03);
    }
    ...
    .auth-input {
      width:100%;padding:.85rem 1rem;background:#f8fafc;border:1.5px solid #e2e8f0;border-radius:12px;
      font-size:.9rem;font-family:inherit;color:#0f172a;transition:all .2s;outline:none;
    }
    ...
    /* SUBMIT */
    .auth-submit-btn {
      width:100%;padding:.85rem 1rem;background:linear-gradient(135deg,rgb(22,38,62),rgb(35,60,100));
      color:white;border:none;border-radius:12px;font-size:.9rem;font-weight:700;font-family:inherit;
      cursor:pointer;transition:all .25s;box-shadow:0 6px 20px rgba(22,38,62,.35);
    ...
    /* CARD LINKS */
    .card-links { display:flex;justify-content:center;gap:.5rem;margin-top:1rem;font-size:.8rem; }
    .card-links a { color:#6366f1;text-decoration:none;font-weight:500; }
    ...
    .btn-outline {
      display:block;width:100%;padding:.8rem;text-align:center;border:1.5px solid #e2e8f0;
      border-radius:12px;background:white;color:#0f172a;font-size:.9rem;font-weight:600;
      text-decoration:none;font-family:inherit;cursor:pointer;transition:all .2s;
    }
